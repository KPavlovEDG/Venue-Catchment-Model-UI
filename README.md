...
- Interactive Map View with macro/axis gap lenses, priority filtering, fixed 1 km catchments, and independently toggleable current/recommended competitor locations
