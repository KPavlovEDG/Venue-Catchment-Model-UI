...
| Spatial discovery | Leaflet map with macro/axis gap lenses, opportunity bands, fixed 1 km venue catchments, direct/indirect competitor markers, and a shared full venue profile drawer |
